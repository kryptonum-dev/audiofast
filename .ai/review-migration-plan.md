...
```typescript
async function shouldMigrateReview(reviewId: string, client: SanityClient): Promise<boolean> {
...
```html
<p>Jest to ekstremalnie neutralny gramofon, czego dokładnie wszyscy 
sobie życzymy, jednak nie oczekiwałem tego od urządzenia w cenie 2395$. 
Spencer Holbert</p>
```
