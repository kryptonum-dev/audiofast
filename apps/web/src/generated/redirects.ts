 ...
 * Generated at: 2026-04-28T14:47:02.495Z
 */
...
export const redirectsMap = new Map<string, RedirectEntry>([
  ...
  ['/apex/', { destination: '/produkty/apex/', permanent: true }],
  ['/powerzone-3/', { destination: '/produkty/powerzone-3/', permanent: true }],
  ['/mephisto/', { destination: '/produkty/mephisto/', permanent: true }],
  ['/vivaldi-clock/', { destination: '/produkty/vivaldi-clock/', permanent: true }],
  ['/srx-sc/', { destination: '/produkty/srx-sc/', permanent: true }],
  ['/recenzje/test-odtwarzacza-ayre-acoustics-cx-8-i-wzmacniacza-ayre-acoustics-ex-8-w-audio/', { destination: '/', permanent: true }],
  ['/srx-powercell/', { destination: '/produkty/srx-powercell/', permanent: true }],
  ['/a15/', { destination: '/produkty/a15/', permanent: true }],
  ['/recenzje/1368/', { destination: '/', permanent: true }],
  ['/recenzje/1417/', { destination: '/', permanent: true }],
  ['/omega-qr-xc/', { destination: '/produkty/omega-qr-xc/', permanent: true }],
  ['/dragon-mono/', { destination: '/produkty/dragon-mono/', permanent: true }],
  ...
  ['/bezpiecznik-master/', { destination: '/produkty/bezpiecznik-master/', permanent: true }],
  ['/recenzje/1013/', { destination: '/', permanent: true }],
  ['/recenzje/1585/', { destination: '/', permanent: true }],
  ['/n100h/', { destination: '/produkty/n100h/', permanent: true }],
  ['/recenzje/1082/', { destination: '/', permanent: true }],
  ['/vt80se/', { destination: '/produkty/vt80se/', permanent: true }],
  ['/the-wattpuppy/', { destination: '/produkty/the-wattpuppy/', permanent: true }],
  ['/recenzje/1944/', { destination: '/', permanent: true }],
  ['/news-galileo-powercell-sx-2020/', { destination: '/', permanent: true }],
  ['/srx-ethernet/', { destination: '/produkty/srx-ethernet/', permanent: true }],
  ['/recenzje/1133/', { destination: '/', permanent: true }],
  ['/recenzje/1080/', { destination: '/', permanent: true }],
  ['/venom-cgcsgc/', { destination: '/produkty/venom-cgcsgc/', permanent: true }],
  ['/alexx/', { destination: '/produkty/alexx/', permanent: true }],
  ['/recenzje/1055/', { destination: '/', permanent: true }],
  ['/i-50/', { destination: '/produkty/i-50/', permanent: true }],
  ['/recenzje/924/', { destination: '/', permanent: true }],
  ['/vivaldi-dac/', { destination: '/produkty/vivaldi-dac/', permanent: true }],
  ['/[file_link,id=14960]/', { destination: '/', permanent: true }],
  ['/bezpiecznik-orange/', { destination: '/produkty/bezpiecznik-orange/', permanent: true }],
  ['/hydra-delta-d6/', { destination: '/produkty/hydra-delta-d6/', permanent: true }],
  ['/foundation-sc/', { destination: '/produkty/foundation-sc/', permanent: true }],
  ...
  ['/ref6se/', { destination: '/produkty/ref6se/', permanent: true }],
  ['/ref10-nano/', { destination: '/produkty/ref10-nano/', permanent: true }],
  ['/recenzje/878/', { destination: '/', permanent: true }],
  ['/sr30-ac/', { destination: '/produkty/sr30-ac/', permanent: true }],
  ['/purple/', { destination: '/produkty/purple/', permanent: true }],
  ['/[file_link,id=14881]/', { destination: '/', permanent: true }],
  ['/dream-petite/', { destination: '/produkty/dream-petite/', permanent: true }],
  ['/sr30-ic/', { destination: '/produkty/sr30-ic/', permanent: true }],
  ['/recenzje/1416/', { destination: '/', permanent: true }],
  ['/recenzje/1554/', { destination: '/', permanent: true }],
  ['/apollo/', { destination: '/produkty/apollo/', permanent: true }],
  ['/foundation-sx-xl-sc/', { destination: '/produkty/foundation-sx-xl-sc/', permanent: true }],
  ['/sasha-daw/', { destination: '/produkty/sasha-daw/', permanent: true }],
  ['/siren/', { destination: '/produkty/siren/', permanent: true }],
  ['/[file_link,id=14885]/', { destination: '/', permanent: true }],
  ['/recenzje/1114/', { destination: '/', permanent: true }],
  ['/p8/', { destination: '/produkty/p8/', permanent: true }],
  ['/galileo-sx-sc/', { destination: '/produkty/galileo-sx-sc/', permanent: true }],
  ['/alpha-x/', { destination: '/produkty/alpha-x/', permanent: true }],
  ['/dragon-hydra/', { destination: '/produkty/dragon-hydra/', permanent: true }],
  ['/tranquility-base/', { destination: '/produkty/tranquility-base/', permanent: true }],
  ['/foundation-ac/', { destination: '/produkty/foundation-ac/', permanent: true }],
  ['/recenzje/1045/', { destination: '/', permanent: true }],
  ['/pedestal/', { destination: '/produkty/pedestal/', permanent: true }],
  ['/srx-powercell-14/', { destination: '/produkty/srx-powercell-14/', permanent: true }],
  ['/refcd9se/', { destination: '/produkty/refcd9se/', permanent: true }],
  ['/bp-2400/', { destination: '/produkty/bp-2400/', permanent: true }],
  ['/commander/', { destination: '/produkty/commander/', permanent: true }],
  ['/recenzje/956/', { destination: '/', permanent: true }],
  ['/n50/', { destination: '/produkty/n50/', permanent: true }],
  ['/404-reference/', { destination: '/produkty/404-reference/', permanent: true }],
  ['/a1-15th-anniversary/', { destination: '/produkty/a1-15th-anniversary/', permanent: true }],
  ['/recenzje/966/', { destination: '/', permanent: true }],
  ['/standart/', { destination: '/produkty/standart/', permanent: true }],
  ['/recenzje/1560/', { destination: '/', permanent: true }],
  ['/roon/', { destination: '/produkty/roon/', permanent: true }],
  ['/recenzje/2320/', { destination: '/', permanent: true }],
  ['/recenzje/1589/', { destination: '/', permanent: true }],
  ['/td-10/', { destination: '/produkty/td-10/', permanent: true }],
  ['/foundation-ic/', { destination: '/produkty/foundation-ic/', permanent: true }],
  ['/prestige/', { destination: '/produkty/prestige/', permanent: true }],
  ['/chronosonic-xvx/', { destination: '/produkty/chronosonic-xvx/', permanent: true }],
  ['/news-test-gryphon-diablo-300/', { destination: '/', permanent: true }],
  ['/vivaldi-upsampler/', { destination: '/produkty/vivaldi-upsampler/', permanent: true }],
  ['/recenzje/1035/', { destination: '/', permanent: true }],
  ['/recenzje/1584/', { destination: '/', permanent: true }],
  ['/parabolica/', { destination: '/produkty/parabolica/', permanent: true }],
  ['/galileo-discovery-sc/', { destination: '/produkty/galileo-discovery-sc/', permanent: true }],
  ['/[file_link,id=14811]/', { destination: '/', permanent: true }],
  ['/atmosphere-sx-ic/', { destination: '/produkty/atmosphere-sx-ic/', permanent: true }],
  ['/ph9/', { destination: '/produkty/ph9/', permanent: true }],
  ['/kodo/', { destination: '/produkty/kodo/', permanent: true }],
  ['/ml-801/', { destination: '/produkty/ml-801/', permanent: true }],
  ['/n200/', { destination: '/produkty/n200/', permanent: true }],
  ['/ls28se/', { destination: '/produkty/ls28se/', permanent: true }],
  ['/recenzje/2404/', { destination: '/', permanent: true }],
  ['/ls28/', { destination: '/produkty/ls28/', permanent: true }],
  ['/paua/', { destination: '/produkty/paua/', permanent: true }],
  ['/apex-ringdac-upgrade/', { destination: '/produkty/apex-ringdac-upgrade/', permanent: true }],
  ['/progression-m550/', { destination: '/produkty/progression-m550/', permanent: true }],
  ['/hdsx-ground-cable/', { destination: '/produkty/hdsx-ground-cable/', permanent: true }],
  ['/srx-ac/', { destination: '/produkty/srx-ac/', permanent: true }],
  ['/powercell-12-uef-se/', { destination: '/produkty/powercell-12-uef-se/', permanent: true }],
  ['/recenzje/1641/', { destination: '/', permanent: true }],
  ['/recenzje/2325/', { destination: '/', permanent: true }],
  ['/alexx-v/', { destination: '/produkty/alexx-v/', permanent: true }],
  ['/recenzje/1533/', { destination: '/', permanent: true }],
  ['/recenzje/1555/', { destination: '/', permanent: true }],
  ['/evo-100-phono-preamplifier/', { destination: '/produkty/evo-100-phono-preamplifier/', permanent: true }],
  ['/recenzje/1031/', { destination: '/', permanent: true }],
  ['/everest-x/', { destination: '/produkty/everest-x/', permanent: true }],
  ['/ua-50/', { destination: '/produkty/ua-50/', permanent: true }],
  ...
  ['/lina-headphone-amplifier/', { destination: '/produkty/lina-headphone-amplifier/', permanent: true }],
  ['/[file_link,id=14684]/', { destination: '/', permanent: true }],
  ['/legato-legacy/', { destination: '/produkty/legato-legacy/', permanent: true }],
  ['/s-100/', { destination: '/produkty/s-100/', permanent: true }],
  ['/atmosphere-sx-ac/', { destination: '/produkty/atmosphere-sx-ac/', permanent: true }],
  ['/eos2/', { destination: '/produkty/eos2/', permanent: true }],
  ['/m3/', { destination: '/produkty/m3/', permanent: true }],
  ['/recenzje/237/', { destination: '/', permanent: true }],
  ['/recenzje/1179/', { destination: '/', permanent: true }],
  ['/sasha-v/', { destination: '/produkty/sasha-v/', permanent: true }],
  ['/recenzje/1326/', { destination: '/', permanent: true }],
  ['/bp-5000/', { destination: '/produkty/bp-5000/', permanent: true }],
  ['/yvette/', { destination: '/produkty/yvette/', permanent: true }],
  ['/nucleus/', { destination: '/produkty/nucleus/', permanent: true }],
  ['/lina-network-dac-2-0/', { destination: '/produkty/lina-network-dac-2-0/', permanent: true }],
  ['/kaliope/', { destination: '/produkty/kaliope/', permanent: true }],
  ['/ethos/', { destination: '/produkty/ethos/', permanent: true }],
  ['/recenzje/1224/', { destination: '/', permanent: true }],
  ['/t-66/', { destination: '/produkty/t-66/', permanent: true }],
  ['/recenzje/1381/', { destination: '/', permanent: true }],
  ['/evo-400-preamplifier/', { destination: '/produkty/evo-400-preamplifier/', permanent: true }],
  ['/recenzje/1361/', { destination: '/', permanent: true }],
  ['/centroid-universal/', { destination: '/produkty/centroid-universal/', permanent: true }],
  ['/powercell-14/', { destination: '/produkty/powercell-14/', permanent: true }],
  ['/sabrina-x/', { destination: '/produkty/sabrina-x/', permanent: true }],
  ['/[file_link,id=15024]/', { destination: '/', permanent: true }],
  ['/sabrina-v/', { destination: '/produkty/sabrina-v/', permanent: true }],
  ['/galileo-discovery-ic/', { destination: '/produkty/galileo-discovery-ic/', permanent: true }],
  ['/brx/', { destination: '/produkty/brx/', permanent: true }],
  ['/recenzje/1129/', { destination: '/', permanent: true }],
  ['/p28/', { destination: '/produkty/p28/', permanent: true }],
  ['/galileo-powercell-sx/', { destination: '/produkty/galileo-powercell-sx/', permanent: true }],
  ['/recenzje/1193/', { destination: '/', permanent: true }],
  ['/powercell-8-uef/', { destination: '/produkty/powercell-8-uef/', permanent: true }],
  ['/recenzje/1024/', { destination: '/', permanent: true }],
  ['/hydra-alpha-a12/', { destination: '/produkty/hydra-alpha-a12/', permanent: true }],
  ...
  ['/forcefield-30-40/', { destination: '/produkty/forcefield-30-40/', permanent: true }],
  ['/bp-1200/', { destination: '/produkty/bp-1200/', permanent: true }],
  ['/bartok-dac/', { destination: '/produkty/bartok-dac/', permanent: true }],
  ['/recenzje/1181/', { destination: '/', permanent: true }],
  ['/rossini-cdsacd-transport/', { destination: '/produkty/rossini-cdsacd-transport/', permanent: true }],
  ['/srx-usb/', { destination: '/produkty/srx-usb/', permanent: true }],
  ['/nowosc-synergistic-research-uef-ethernet-switch/', { destination: '/', permanent: true }],
  ['/galileo-discovery-ac/', { destination: '/produkty/galileo-discovery-ac/', permanent: true }],
  ['/[file_link,id=15119]/', { destination: '/', permanent: true }],
  ['/diablo-333/', { destination: '/produkty/diablo-333/', permanent: true }],
  ['/rossini-player/', { destination: '/produkty/rossini-player/', permanent: true }],
  ['/n20/', { destination: '/produkty/n20/', permanent: true }],
  ['/powercell-one/', { destination: '/produkty/powercell-one/', permanent: true }],
  ['/recenzje/1481/', { destination: '/', permanent: true }],
  ['/bp-600/', { destination: '/produkty/bp-600/', permanent: true }],
  ['/srx-ic/', { destination: '/produkty/srx-ic/', permanent: true }],
  ...
  ['/w20/', { destination: '/produkty/w20/', permanent: true }],
  ['/iqrp-3600/', { destination: '/produkty/iqrp-3600/', permanent: true }],
  ...
  ['/gemini/', { destination: '/produkty/gemini/', permanent: true }],
  ['/td-20/', { destination: '/produkty/td-20/', permanent: true }],
  ['/ref-10/', { destination: '/produkty/ref-10/', permanent: true }],
  ['/progression-s350/', { destination: '/produkty/progression-s350/', permanent: true }],
  ['/dcs-ring-dac/', { destination: '/', permanent: true }],
  ['/everest8000/', { destination: '/produkty/everest8000/', permanent: true }],
  ['/foundation-usb/', { destination: '/produkty/foundation-usb/', permanent: true }],
  ['/vip-ic/', { destination: '/produkty/vip-ic/', permanent: true }],
  ['/rp-7/', { destination: '/produkty/rp-7/', permanent: true }],
  ['/helios/', { destination: '/produkty/helios/', permanent: true }],
  ...
  ['/ref160m/', { destination: '/produkty/ref160m/', permanent: true }],
  ['/altaira/', { destination: '/produkty/altaira/', permanent: true }],
  ['/m1/', { destination: '/produkty/m1/', permanent: true }],
  ['/ref80s/', { destination: '/produkty/ref80s/', permanent: true }],
  ['/loke/', { destination: '/produkty/loke/', permanent: true }],
  ['/n30sa/', { destination: '/produkty/n30sa/', permanent: true }],
  ['/recenzje/2348/', { destination: '/', permanent: true }],
  ['/sigma-nr/', { destination: '/produkty/sigma-nr/', permanent: true }],
  ['/ml-802/', { destination: '/produkty/ml-802/', permanent: true }],
  ['/recenzje/1547/', { destination: '/', permanent: true }],
  ['/srx-xl-sc/', { destination: '/produkty/srx-xl-sc/', permanent: true }],
  ['/alexia/', { destination: '/produkty/alexia/', permanent: true }],
  ['/recenzje/1143/', { destination: '/', permanent: true }],
  ['/progression-integrated-amplifier/', { destination: '/produkty/progression-integrated-amplifier/', permanent: true }],
  ['/recenzje/1242/', { destination: '/', permanent: true }],
  ['/srx-digital/', { destination: '/produkty/srx-digital/', permanent: true }],
  ['/recenzje/1480/', { destination: '/', permanent: true }],
  ['/sakra/', { destination: '/produkty/sakra/', permanent: true }],
  ['/exoteryc/', { destination: '/produkty/exoteryc/', permanent: true }],
  ...
  ['/theta-ic/', { destination: '/produkty/theta-ic/', permanent: true }],
  ['/srx-phono/', { destination: '/produkty/srx-phono/', permanent: true }],
  ['/ebravo/', { destination: '/produkty/ebravo/', permanent: true }],
  ['/vx-8/', { destination: '/produkty/vx-8/', permanent: true }],
  ['/bezpiecznik-pink/', { destination: '/produkty/bezpiecznik-pink/', permanent: true }],
  ['/lina-clock/', { destination: '/produkty/lina-clock/', permanent: true }],
  ['/mu2/', { destination: '/produkty/mu2/', permanent: true }],
  ['/n150/', { destination: '/produkty/n150/', permanent: true }],
  ['/recenzje/1036/', { destination: '/', permanent: true }],
  ['/sigma-alpha-delta-nr-xc-v2/', { destination: '/produkty/sigma-alpha-delta-nr-xc-v2/', permanent: true }],
  ['/mata-uef1/', { destination: '/produkty/mata-uef1/', permanent: true }],
  ['/antileon-evo/', { destination: '/produkty/antileon-evo/', permanent: true }],
  ['/recenzje/1545/', { destination: '/', permanent: true }],
  ['/powercell-two/', { destination: '/produkty/powercell-two/', permanent: true }],
  ['/[file_link,id=14707]/', { destination: '/', permanent: true }],
  ['/n10/', { destination: '/produkty/n10/', permanent: true }],
  ['/vivaldi-one/', { destination: '/produkty/vivaldi-one/', permanent: true }],
  ['/momentum-s250-mvx/', { destination: '/produkty/momentum-s250-mvx/', permanent: true }],
  ['/altaira-x/', { destination: '/produkty/altaira-x/', permanent: true }],
  ['/s4/', { destination: '/produkty/s4/', permanent: true }],
  ['/sr30-sc/', { destination: '/produkty/sr30-sc/', permanent: true }],
  ['/recenzje/1042/', { destination: '/', permanent: true }],
  ['/triton-reference/', { destination: '/produkty/triton-reference/', permanent: true }],
  ['/recenzje/933/', { destination: '/', permanent: true }],
  ['/atmosphere-sx-sc/', { destination: '/produkty/atmosphere-sx-sc/', permanent: true }],
  ['/recenzje/1142/', { destination: '/', permanent: true }],
  ['/acoustic-diode/', { destination: '/produkty/acoustic-diode/', permanent: true }],
  ['/recenzje/919/', { destination: '/', permanent: true }],
  ['/recenzje/1059/', { destination: '/', permanent: true }],
  ['/recenzje/1060/', { destination: '/', permanent: true }],
  ['/powercellsx/', { destination: '/produkty/powercellsx/', permanent: true }],
  ['/black-diamond-dlc/', { destination: '/produkty/black-diamond-dlc/', permanent: true }],
  ['/pandora/', { destination: '/produkty/pandora/', permanent: true }],
  ['/galileo-sx-ic/', { destination: '/produkty/galileo-sx-ic/', permanent: true }],
  ['/recenzje/1601/', { destination: '/', permanent: true }],
  ['/[product_link,id=]/', { destination: '/', permanent: true }],
  ['/alexia-v/', { destination: '/produkty/alexia-v/', permanent: true }],
  ['/foundation-ethernet/', { destination: '/produkty/foundation-ethernet/', permanent: true }],
  ['/isis-rack/', { destination: '/produkty/isis-rack/', permanent: true }],
  ['/relentless-preamplifier/', { destination: '/produkty/relentless-preamplifier/', permanent: true }],
  ['/trident-ii/', { destination: '/produkty/trident-ii/', permanent: true }],
  ['/pharaoh/', { destination: '/produkty/pharaoh/', permanent: true }],
  ['/iqrp-1500/', { destination: '/produkty/iqrp-1500/', permanent: true }],
  ['/recenzje/884/', { destination: '/', permanent: true }],
  ['/recenzje/1015/', { destination: '/', permanent: true }],
  ['/momentum-m400-mvx/', { destination: '/produkty/momentum-m400-mvx/', permanent: true }],
  ['/relentless/', { destination: '/produkty/relentless/', permanent: true }],
  ['/voodoo/', { destination: '/produkty/voodoo/', permanent: true }],
  ['/foundation-digital/', { destination: '/produkty/foundation-digital/', permanent: true }],
  ['/recenzje/1083/', { destination: '/', permanent: true }],
  ['/galileo-ground-block/', { destination: '/produkty/galileo-ground-block/', permanent: true }],
  ['/recenzje/1267/', { destination: '/', permanent: true }],
  ['/sphinx/', { destination: '/produkty/sphinx/', permanent: true }],
  ['/evo-400-integrated/', { destination: '/produkty/evo-400-integrated/', permanent: true }],
  ['/recenzje/1856/', { destination: '/', permanent: true }],
  ['/sigma-x/', { destination: '/produkty/sigma-x/', permanent: true }],
  ['/recenzje/1544/', { destination: '/', permanent: true }],
  ['/recenzje/1364/', { destination: '/', permanent: true }],
  ['/a30/', { destination: '/produkty/a30/', permanent: true }],
  ['/evo-300-hybrid-integrated/', { destination: '/produkty/evo-300-hybrid-integrated/', permanent: true }],
  ['/galileo-sx-ac/', { destination: '/produkty/galileo-sx-ac/', permanent: true }],
  ['/mu1/', { destination: '/produkty/mu1/', permanent: true }],
  ['/uef-ethernet-switch/', { destination: '/produkty/uef-ethernet-switch/', permanent: true }],
  ['/progression-mono/', { destination: '/produkty/progression-mono/', permanent: true }],
  ['/atmosphere/', { destination: '/produkty/atmosphere/', permanent: true }],
  ['/ex-8/', { destination: '/produkty/ex-8/', permanent: true }],
  ['/recenzje/1767/', { destination: '/', permanent: true }],
  ['/recenzje/1106/', { destination: '/', permanent: true }],
  ['/foundation-ground-cable/', { destination: '/produkty/foundation-ground-cable/', permanent: true }],
  ['/vivaldi-transport/', { destination: '/produkty/vivaldi-transport/', permanent: true }],
