...
export default function EmptyState({ searchTerm, category }: EmptyStateProps) {
  const getTitle = () => {
    if (searchTerm && category) return 'Nie znaleziono wyników';
  ...
  const getDescription = () => {
    ...
    return 'Ta kategoria nie zawiera jeszcze żadnych publikacji';
  };
  ...
  const getHint = () => {
    ...
    return 'Wróć do wszystkich publikacji lub wybierz inną kategorię';
  };
