  ...
  return (
    <section className={styles.ordersPage}>
      {/* <div className={styles.topBar}>
        <div className={styles.headingBlock}>
          ...
          <p className={styles.description}>
            Tutaj znajdziesz zamówienia przypisane do zweryfikowanego adresu
            e-mail.
          </p>
        </div>
      </div>
      ...
      {pageData.hasLoadError ? (
        ...
        <section className={styles.stateCard}>
          <h2 className={styles.stateHeading}>Brak zamówień do wyświetlenia</h2>
          <p className={styles.stateDescription}>
            Po zalogowaniu pokazujemy tylko zamówienia aktywne lub widoczne dla
            klienta. Szczegóły zamówień dodamy w kolejnych krokach tej fazy.
          </p>
          <div className={styles.stateActions}>
            <Button
              href="/produkty/"
            ...
            <li key={order.id} className={styles.orderCard}>
              <div className={styles.orderHeader}>
                <div className={styles.orderIdentity}>
                  <span className={styles.orderEyebrow}>Numer zamówienia</span>
